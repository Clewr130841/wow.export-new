...
const main = async (attempts) => {
	...
	const version = argv[3] || '11.2.0.63003';
	const mapId = argv[4] || 30;
	const exportPath = argv[5] || 'C:\\Users\\Hrust\\OneDrive\\Рабочий стол\\wowexport\\myfork-new\\tests\\11.2.0.62493';
